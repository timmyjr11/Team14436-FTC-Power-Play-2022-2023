...
@Config
@Autonomous
public class StateAutoV0_75 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence leftSideV3 = d.trajectorySequenceBuilder(d.getPoseEstimate())
        ...
        TrajectorySequence leftSideV3Cone1 = d.trajectorySequenceBuilder(leftSideV3.end())
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(-16, -7), Math.toRadians(315))
                .splineToSplineHeading(new Pose2d(-13, -11.25, Math.toRadians(180)), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(-25, -11.25), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(-59.5, -11.25), Math.toRadians(180))
                .build();
        ...
        d.followTrajectorySequence(leftSideV3);
        d.followTrajectorySequence(leftSideV3Cone1);
