...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(10.5, 0, 1); // 10.5, 0, 1
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(9, 0, 1); // 9, 0, 1

    public static double LATERAL_MULTIPLIER = 90.0/68.25; // yo fix this
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.3, 0.5, Math.toRadians(1)), 0.5);
